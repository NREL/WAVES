...
from landbosse.model import Manager  # noqa: E402
from landbosse.excelio import XlsxReader  # noqa: E402
from landbosse.excelio.XlsxManagerRunner import XlsxManagerRunner  # noqa: E402
...
class LandBOSSERunner:
    ...
    expected_config: typing.ClassVar[dict] = {
        ...
        "component": {
            ...
            "blade": {
                "mass_t": "Blade mass (t)",
                "surface_area_m2": "Blade surface area (m^2)",
            },
            "tower_section": {
    ...
    def get_project_parameters(self) -> pd.Series:
        ...
        KEYS_RENAME = {
            ...
            "combined_homerun_trench_length_km": "Combined homerun trench length to substation "
            "(km)",
        ...
        if bool(missing_parameters):
            ...
            raise ValueError(
                "The following LandBOSSE parameters are missing:\n\n{missing_params_all:s}".format(
                    missing_params_all="\n".join(missing_parameters_list)
                ),
            )
        ...
        project_parameters = project_parameters.rename(KEYS_RENAME)
    ...
    def add_header_to_weather_dataframe(weather_window: pd.DataFrame) -> pd.DataFrame:
        """Add blank header rows to the weather dataframe from WAVES to match the format expected by
         LandBOSSE.

        Returns
        -------
        pd.DataFrame
            Weather dataframe with header.
        """
        NUM_HEADER_ROWS = 5
